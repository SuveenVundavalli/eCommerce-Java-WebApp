...
public class UserDAOImpl implements UserDAO {
	 ...
	 * created successfully, it will return true else it will return false
	 */
	public boolean save(User user) {
		try {
			...
			e.printStackTrace();
			// if any exception arises during execution of try block, catch will be executed
			return false;
		}
		return true;
	...
	/*
	 * This save method update record in the User table. If the record is
	 * updated successfully, it will return true else it will return false
	 */
	...
	/*
	 * validate method will return true if the credentials are correct else will return false
	 */
